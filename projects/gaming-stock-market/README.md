...
Gaming Stock Market - это полнофункциональная биржа акций для торговли "акциями" игровых персонажей и команд в реальном времени. Система построена на микросервисной архитектуре с использованием современных технологий и best practices.

### 🎯 Основная концепция

Пользователи могут покупать и продавать "акции" игровых персонажей и команд, стоимость которых меняется в зависимости от:
