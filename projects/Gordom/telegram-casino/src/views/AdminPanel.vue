  ...
  <div class="admin-panel">
    ...
    <div class="admin-header">
      <div class="header-content">
        <h1>🎯 Админ Панель</h1>
        <p>Управление спортивными событиями и ставками</p>
      </div>
    ...
    <div class="admin-content">
      ...
      <div v-if="activeTab === 'events'" class="events-tab">
        ...
        <div v-if="showOddsModal" class="modal-overlay">
          <div class="modal">
            <div class="modal-header">
              <h3>Редактирование коэффициентов</h3>
      ...
      <div v-if="activeTab === 'users'" class="users-tab">
        ...
        <div class="users-list">
          <div class="user-item user-header">
            <div class="user-info">Пользователь</div>
            <div class="user-balance">Баланс</div>
            <div class="user-status">Статус</div>
            <div class="user-actions">Действия</div>
          </div>
          ...
          >
            ...
            <div class="user-actions">
              <button @click="banUser(user)" class="btn-ban">Забанить</button>
              <button @click="resetUserBalance(user)" class="btn-reset">Сбросить баланс</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="activeTab === 'stats'" class="stats-tab">
        <div class="tab-header">
          ...
          <div class="date-filter">
            ...
            <button @click="loadStats" class="btn-filter">Применить</button>
          </div>
        </div>
      ...
      <div v-if="activeTab === 'settings'" class="settings-tab">
        ...
        <div class="settings-form">
          ...
          <div class="form-actions">
            <button @click="saveSettings" class="btn-primary">Сохранить настройки</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    const events = ref([])
    const users = ref([
      { id: 1, name: 'Иван Петров', email: 'ivan@example.com', balance: 1500, status: 'active' },
      { id: 2, name: 'Мария Иванова', email: 'maria@example.com', balance: 2300, status: 'active' },
      { id: 3, name: 'Алексей Сидоров', email: 'alex@example.com', balance: 800, status: 'banned' },
    ])
    ...
    // Navigation tabs
    const tabs = ref([
      { id: 'events', name: 'События', icon: 'fas fa-calendar' },
