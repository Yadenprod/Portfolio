  ...
  <div id="app">
    ...
    <main class="pl-[118px] pt-[16px] transition-all duration-200 pb-[50px] lg:pl-0 lg:pr-0 lg:pb-[86px]" :class="chatOpen ? 'pr-[318px]' : 'pr-[52px]'">
      <div class="max-w-[1232px] 2xl:max-w-[925px] px-[16px] mx-auto">
        ...
        <div class="layout pt-[20px] lg:pt-[55px]"><router-view/></div>
      </div>
    </main>
    <Chat @chatInitState="chatInitState" :chatOpen="chatOpen"></Chat>
    <MobileMenu @chatInitState="chatInitState" :chatOpen="chatOpen"></MobileMenu>
    <img class="absolute -z-[1] left-0 top-0 w-full h-full object-cover" src="/images/background.png"/>
  </div>
