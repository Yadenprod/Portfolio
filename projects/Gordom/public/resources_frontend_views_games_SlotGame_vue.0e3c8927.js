...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "sm:hidden ms:relative absolute left-0 flex items-center h-[36px] rounded-[14px] overflow-hidden transition-all duration-200 text-white bg-[#696f96]",
    attrs: {
      href: "javascript:;"
    },
    on: {
