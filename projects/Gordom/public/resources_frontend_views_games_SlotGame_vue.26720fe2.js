...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "sm:relative absolute left-0 flex items-center h-[36px] rounded-[14px] overflow-hidden transition-all duration-200 text-white bg-[#696f96]",
    attrs: {
      href: "javascript:;"
    },
    on: {
    ...
    staticClass: "sm:relative absolute transition-all duration-200 hover:bg-[#696f96] hover:shadow-[0px_3px_22px_rgba(0,0,0,0.05)] rounded-full hover:text-white right-0 w-[48px] h-[48px] text-[#696F96] flex items-center justify-center",
    attrs: {
      href: "javascript:;"
    },
    on: {
