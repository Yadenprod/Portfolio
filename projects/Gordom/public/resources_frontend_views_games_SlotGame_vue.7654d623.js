...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "ms:relative absolute transition-all duration-200 hover:bg-white hover:shadow-[0px_3px_22px_rgba(0,0,0,0.05)] rounded-full hover:text-[#8232E8] right-0 w-[48px] h-[48px] text-[#696F96] flex items-center justify-center",
    attrs: {
      href: "javascript:;"
    }
  }, [_c("svg", {
...
var staticRenderFns = [function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("a", {
    staticClass: "ms:relative absolute left-0 flex items-center h-[36px] text-[#526188] rounded-[14px] overflow-hidden transition-all duration-200 hover:text-white",
    attrs: {
      href: "/slots"
    }
  }, [_c("div", {
