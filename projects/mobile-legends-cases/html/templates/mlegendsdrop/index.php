...
<html>
	<head>
		...
		<link href="<?php the_template_folder(); ?>/css/style1.css?v=1.1" rel="stylesheet" type="text/css">
		<link href="<?php the_template_folder(); ?>/css/mobile1.css?v=1.1" rel="stylesheet" type="text/css">
