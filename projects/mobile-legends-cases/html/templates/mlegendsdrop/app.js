...
Vue.prototype.VK_URL = 'https://vk.com/mlegendsdrop';
...
Vue.component('ml-cases', require('./components/pages/MLCasesPage.vue').default);
...
Vue.component('page-404', require('./components/pages/Page404.vue').default);
